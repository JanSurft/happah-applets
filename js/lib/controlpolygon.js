//////////////////////////////////////////////////////////////////////////////
//
// A polygon between a set of controlpoints.
// Can be extended at both ends
...
define(['jquery', 'three', './spherical-impostor', './util'], function($, THREE, happah, UTIL) {
     ...
     class ControlPolygon {
          ...
          constructor(scene, camera, limit = 0) {
               this.onMouseDoubleclick = this.onMouseDoubleclick.bind(this);
               this.onMouseClick = this.onMouseClick.bind(this);
               this.enterAddMode = this.enterAddMode.bind(this);

               this[s_impostors] = new THREE.Group();

               this[s_scene] = scene;
               this[s_scene].add(this[s_impostors]);
          ...
          get vectors() {
               return this[s_vectors];
          }
          get points() {
               return this[s_impostors];
          }
          set limit(limit) {
               this[s_limit] = limit;
          }
