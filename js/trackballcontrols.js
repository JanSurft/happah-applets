    ...
    class TrackballControls {
        ...
        onMouseMove(event) {
            ...
            if (this[s_moving]) {
                ...
                var ray = new happah.Ray(this[s_raycaster].ray.origin, this[s_raycaster].direction);
                ...
                var ray1 = sphere.center.add(this[s_previousIntersect]);
                var ray2 = sphere.center.add(newIntersect);
                ...
                quaternion.setFromAxisAngle(axis, angle * 0.015);
